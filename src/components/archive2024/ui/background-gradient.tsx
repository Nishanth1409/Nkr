    ...
    <div className={cn('group relative p-[4px]', containerClassName)}>
      ...
      <motion.div
        ...
        className={cn(
          ...
          'bg-[radial-gradient(circle_farthest-side_at_0_100%,#00FFFF,transparent),radial-gradient(circle_farthest-side_at_100%_0,#ec4899,transparent),radial-gradient(circle_farthest-side_at_100%_100%,#9333ea,transparent),radial-gradient(circle_farthest-side_at_0_0,#EBEDE9,#141316)]',
        )}
      />
